...
const BINARY_URL = 'https://raw.githubusercontent.com/yunhailanuxgk/uxgk-wallet/master/clientBinaries.json'
    ...
    return got(BINARY_URL, {
      ...
      .then(localConfig => {
        ...
        return mgr
          .init({
            folders: [
              path.join(Settings.userDataPath, 'binaries', 'uxgk', 'unpacked')
            ]
          })
          .then(() => {
          ...
          dialog.showMessageBox(
            {
              type: 'warning',
              buttons: ['OK'],
              message: global.i18n.t('imWallet.errors.nodeChecksumMismatch.title'),
              detail: global.i18n.t(
                'imWallet.errors.nodeChecksumMismatch.description',
                {
                  type: nodeInfo.type,
