...
class Settings {
  ...
  get chainDataPath () {
    ...
    if (this.platform === 'win') {
      dataDir = path.join(dataDir, 'AppData', 'Roaming', 'uxgk')
    } else if (this.platform === 'mac') {
      dataDir = path.join(dataDir, 'Library', 'uxgk')
    } else {
      dataDir = path.join(dataDir, '.uxgk')
    }
    if (this.isTestnet) {
  ...
  get chainDataDir () {
    return path.join(this.chainDataPath, 'uxgk', 'chaindata')
  }
